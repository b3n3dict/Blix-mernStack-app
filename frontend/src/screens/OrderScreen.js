                 ...
                 <ListGroup variant="flush">
                     <ListGroup.Item>
                        ...
                        <p> <strong>Email: </strong><a href={`mailto:${order.user.email}`}> {order.user.email}</a>
                         ...
                         {order.isDelevered ? <Message severity="success">Delivered on {order.deleveredAt}</Message> :
                             ...
                             {!order.isPaid &&  (
                                 <ListGroup.Item>
                                     ...
                                     {!sdkReady ? <Loader/> : (
                                         ...
                                         onSuccess={successPaymentHandler}  currency="INR"/>
                                     )}
                                 </ListGroup.Item>
                             )}
                             {deliverLoading && <loading/>}
                             {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelevered &&(
                                  <ListGroup.Item>
